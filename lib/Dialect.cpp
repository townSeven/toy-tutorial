...
/// [ch4] Infer the output shape of the CastOp, this is required by the shape
/// inference interface.
...
/// [ch4] Infer the output shape of the MulOp, this is required by the shape inference interface.
